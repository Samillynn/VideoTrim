...
def parse_args():
    ...
    argparser.add_argument('-o', '--outfolder',
                           help='config where to output videos', default='.')
    argparser.add_argument('-c', '--config',
                           help='config the right config.txt file', default='config.txt')
    argparser.add_argument('-w', '--max_workers', type=int, default=4,
